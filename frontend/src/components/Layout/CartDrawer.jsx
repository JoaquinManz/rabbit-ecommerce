  ...
  return (
    <div    
        ...
        `}>
            ...
            <div className='py-4 px-2 bg-white sticky bottom-0'>
                ...
                <p className='text-sm tracking-tighter text-gray-500 mt-2 text-center'>Shipping, taxes, and discounts are applied at checkout.</p>
            </div>
    </div>
        )
}
